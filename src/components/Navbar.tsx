    ...
    <div className="py-4 bg-white top-0 sticky z-10 shadow-lg font-karla">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="text-3xl font-bold " data-test="main-logo">
       <span className="logo-cinzel">Revo</span>'s Store
          </Link>
          <div className="lg:flex hidden w-full max-w-[500px]">
            <input
              type="text"
              placeholder="Search for a product..."
              className="border-2 border-slate-500 px-6 py-2 w-full"
            />
            <div className="bg-slate-600 text-white text-[26px] grid place-items-center px-4">
              <BsSearch />
            </div>
          </div>
          <div className="flex gap-4 md:gap-8 items-center">
            ...
            <div className="flex items-center gap-2">
              {username !== "" ? (
                <img
                  src="https://robohash.org/Lenna.png?set=set4"
                  alt="avatar"
                  className="w-6"
                />
              ) : (
