        ...
        {checkout ? (
          <div className="max-w-[400px] w-full min-h-full bg-white absolute right-0 top-0 p-6 font-karla">
            ...
            <p className="leading-4 mb-3">
              Welcome to the checkout section. This is an Front-end Project, I haven't implemented any payment related task. If you
              ...
              mention, order history hasn't been developed because this is completely a front-end project.
            </p>
