          ...
          {clicked ? (
            <>
              ...
              <p className="leading-4">
                This is a E-Commerce Website built only using Front-end Technologies. Please use <b>Revo</b> as
                username & <b>12345678</b> as password. You can find these
              ...
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Your username here... (Revo)"
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder="Your password here... (12345678)"
                    className="border w-full border-black py-2 px-8 rounded"
                  />
                ...
                <input
                  ...
                  type="submit"
                  value="Submit"
                  className="bg-indigo-400 text-white rounded p-2 hover:bg-indigo-300 cursor-pointer"
                />
              </form>
