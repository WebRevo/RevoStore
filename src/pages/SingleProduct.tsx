      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-4 font-karla">
        ...
        <div className="px-2">
          ...
          <div className="flex flex-wrap items-center mt-4 mb-2 space-x-2">
            <button
              type="button"
              className="flex items-center space-x-1 mb-2 hover:bg-[#b2b2b2] text-white p-2 rounded bg-[#57575b]"
              onClick={addCart}
            >
            ...
            <button
              type="button"
              className="flex items-center space-x-1 mb-2 bg-green-500 text-white p-2 rounded hover:bg-green-700"
              onClick={buyNow}
            >
              <FaHandHoldingDollar />
              <span>BUY NOW</span>
